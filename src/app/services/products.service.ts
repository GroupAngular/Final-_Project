...
products = [
  {
    id: 1, partId: 1,      name: "Elegant Ceramic Dinner Set",
  ...
  {
    id: 2, partId: 1,      name: "Porcelain Dinner Plates Set",
  ...
  {
    id: 3, partId: 1,      name: "Glass Dinner Plates Set",
  ...
  {
    id: 4, partId: 1,      name: "Stoneware Dinner Plates Set",
  ...
  {
    id: 5, partId: 1,      name: "Vintage Porcelain Dinner Set",
  ...
  {
    id: 6, partId: 1,      name: "Luxury Dinner Plate Set",
  ...
  {
    id: 7, partId: 1,      name: "Modern Ceramic Dinnerware Set",
  ...
  {
    id: 8, partId: 2,    name: "TORNADO Blender With 2 Mills",
       ...
       ,
       {
        ...
        images: [
         ...
         ,
         {
          ...
          {
            id: 17, partId: 3,             name: "Sharp Carousel Microwave",
          ...
          },
          {
            ...
            images: ["images/part18.webp", "images/part19.1.jpg", "images/part19.2.jpg"]
          },
          {
            id: 20, partId: 4, 
            ...
            images: ["images/part20.webp", "images/part20.1.jpg", "images/part20.2.jpg"]
          },
          {
            id: 21, partId: 4, 
...
// Wishlist management
private promoCode = 'DISCOUNT10'; // Valid promo code for 10% discount
  private discount = 0; // Discount percentage
...
addToWishlist(product: any) {
  ...
  if (!wishlist.find((item: any) => item.id === product.id)) {
    ...
    this.wishlistChanged.emit(); // Notify that wishlist has changed
  }
}
...
this.CartChanged.emit(); // Notify that wishlist has changed
...
cart=cart.filter((itemcart:any)=>itemcart.id !== product.id);
localStorage.setItem(this.cartKey,JSON.stringify(cart))
this.CartChanged.emit(); // Notify that wishlist has changed
  ...
  updateQuantity(productId: number, quantity: number): void {
    ...
    localStorage.setItem(this.cartKey, JSON.stringify(cart));
    this.CartChanged.emit();  // Notify listeners that the cart has changed
  }

  // Apply a promo code and set the discount
...
isInCart(product: any): boolean {
 ...
 // Get related products by partId
 getRelatedProducts(partId: number) {
